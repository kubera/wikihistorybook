...
/**
 * This class is mainly copied from the student work. Introduced a interface to
 * get rid of the java swing components, which will be found again in the applet
 * version.
 * 
    ...
    private void setIndegrees() {
        try {
            ...
            while (people.next()) {
                ...
                try {
                    graph.getNode(people.getString("id")).changeAttribute("ui.style",
                            "fill-color: rgb(" + r + "," + g + "," + b + "); size: " + size + "px;");

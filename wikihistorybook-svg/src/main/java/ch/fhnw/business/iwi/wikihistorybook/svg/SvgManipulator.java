...
/**
 * Manipulates the byte stream SVG graph, generated by the graph-stream library,
 * and manipulates the graph to a more advanced SVG.
 * 
...
public class SvgManipulator {
    ...
    public ByteArrayOutputStream manipulate() {
        ...
        SvgAnalyseHandler analyser = new SvgAnalyseHandler();
